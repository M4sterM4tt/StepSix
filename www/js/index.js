	...
	if (pause == false) {
		...
		for(loopThree = 0; loopThree < wallType.length; loopThree+=1) {		
			...
			if (wallDefaultType[loopThree] == 6) {
				if (touch.pageX + canvas.width/8 < wallPositionX[loopThree] + canvas.width/20 && touch.pageX + canvas.width/8 > wallPositionX[loopThree] && touch.pageY + canvas.width/8 < wallPositionY[loopThree] + canvas.height/10 && touch.pageY + canvas.width/8 > wallPositionY[loopThree]) {			
	...
	if (pause == false) {
		...
		for(loopThree = 0; loopThree < wallType.length; loopThree+=1) {	
			...
			if (wallDefaultType[loopThree] == 3 && breaker == 0) {
				if (touch.pageX + canvas.width/8 < wallPositionX[loopThree] + canvas.width/20 && touch.pageX + canvas.width/8 > wallPositionX[loopThree] - (1/2)*canvas.width/20 && touch.pageY + canvas.width/8 < wallPositionY[loopThree] + 2*canvas.height/10 && touch.pageY + canvas.width/8 > wallPositionY[loopThree]  - canvas.height/10) {	
